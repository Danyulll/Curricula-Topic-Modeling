...
Degree_pathway <-
  c(Degree_pathway, sample(unlist(
    str_split(ds_cal$Category.Description[5], "or")
  ), 1))
Degree_pathway <-
  c(Degree_pathway, sample(unlist(
...
# Choose 1 of the following (U2):
newcourses <-
  sample(c("DATA C100", "COMPSCI C100", "STAT C100"), 1)
...
save(degree_corpus,file="./degree_corpus.RData")
